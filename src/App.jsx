...
function App() {
  ...
  async function GetTotalAttempts() {
    ...
    await fetch('https://jrar-latest.onrender.com/api/attempts/total')
  ...
  async function GetAttemptsToday() {
    await fetch('https://jrar-latest.onrender.com/api/attempts/today')
      .then(response => response.json())
      .then(data => setAttemptsToday(data.total_attempts))
      .catch(error => console.error('Error fetching attempts today:', error));
  }
  async function GetMonthlySummary() {
    await fetch('https://jrar-latest.onrender.com/api/attempts/monthly_summary')
      .then(response => response.json())
  ...
  async function GetCardList() {
    ...
    await fetch('https://jrar-latest.onrender.com/api/cards')
      .then(response => response.json())
      .then(data => {
        setCardList(data)
      })
  ...
  async function handleAddItem() {
    if (inputValue.trim()) {
      await fetch('https://jrar-latest.onrender.com/api/card', {
        method: 'POST',
        headers: {
  ...
  async function handleDelete(e) {
    await fetch(`https://jrar-latest.onrender.com/api/cards/${e.target.id}`, {
      method: 'DELETE',
    })
      .then(response => response.json())
      .then(data => {
